...
export function CarBoxRenew2({
  id
}: ICar) {
  return (
    <section>
      <section className="car-box car-box-small relative pointer cbr2">
        ...
        <section className="flex ai-c">
          ...
          <section className="w-100">
            <img src="https://res.cloudinary.com/do8ssnxjw/image/upload/v1709053791/tni6xss8zodmiqihbsk9.jpg" />
          </section>
